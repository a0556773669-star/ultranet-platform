...
**ההפקה היא ידנית בלבד, ולעולם לא אוטומטית — וזה אילוץ עסקי, לא העדפה.** הגבייה עוברת דרך
נדרים פלוס, ושם מוגדר שכל עסקה מפיקה חשבונית מס קבלה **בעצמה**. הפקה אוטומטית גם מכאן
מייצרת שני מסמכים על אותו תשלום, וזה כבר קרה. לכן:
