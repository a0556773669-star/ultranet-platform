...
import { getMilestonesByMonthKey, getMilestonesByStage, getAllRocks, getReview, listReviews } from "../actions";
import { currentMonthKey, shiftMonthKey, monthLabel } from "../date-utils";
...
export default async function RocksMonthPage({ searchParams }: { searchParams: { m?: string } }) {
  ...
  const [monthMilestones, allMonthStage, rocks, review, reviews] = await Promise.all([
