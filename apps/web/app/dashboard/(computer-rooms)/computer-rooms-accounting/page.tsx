  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-xs text-muted">
        ...
        נכנס עד היום, וכמה מהרווח עדיין מוחזק. עלות ההקמה עצמה היא מעקב סטטוס בלבד ולא מופיעה
        בהנה&quot;ח הראשית. ההוצאות המוצגות כאן כן ממשיכות להתחשבן שם כרגיל (חלק הבעלים בלבד -
        ראו &quot;הוצאות&quot;). לעומת זאת ההכנסה החודשית שמוסיפים כאן היא שורה ידנית למעקב בלבד -
