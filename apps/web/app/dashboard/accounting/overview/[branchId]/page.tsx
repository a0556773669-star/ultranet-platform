        ...
        <div className="mb-3 rounded-card border border-[#f0dcb8] bg-[#fdf3e3] px-4 py-3 text-[12.5px] font-bold leading-relaxed text-[#7a4a12]">
          {stats.status === "before_open" ? (
            ...
            <>
              ...
              (סינון וגלישה וכו&apos;) ולא שורת פרסום משותף, אין לו הכנסות ואין מה להעביר לבעלים, גם אם כבר הוזנו אליו נתונים. כדי
            ...
            <>
              ...
              הוגדר לו תאריך פתיחה ואין בו אף לקוח, השכרה, הכנסה או הוצאה. לכן אין לו הוצאות תעריפון (סינון וגלישה
              וכו&apos;) ואין מה להעביר לבעלים. ברגע שיוזנו לקוחות והשכרות — או שיוגדר תאריך פתיחה — החישוב
