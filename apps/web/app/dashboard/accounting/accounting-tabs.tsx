...
/**
 * ניווט ההנה"ח הראשית — שישה מסכים.
 *
 ...
 * שבהם באמת קורה משהו: הספר עצמו, המעקב אחרי הניידים, ההעברות, ההוצאות שלי, המעקב
 * השנתי אחרי מוצרים שקונים שוב ושוב, ומסך חד-פעמי לעדכן את מה שכבר היה כאן לפני
 * שהדגל נולד.
 */
const TABS = [
  ...
  { href: "/dashboard/accounting/recurring-purchases", label: "רכישות חוזרות" },
