...
import { currentMonth } from "@/lib/branch-accounting-data";
import type { BranchLedger, LedgerMonthRow } from "@/lib/branch-ledger";
...
export function BalanceSummaryCard({ ledger }: { ledger: BranchLedger }) {
...
export function BranchLedgerTable({ ledger }: { ledger: BranchLedger }) {
